// This page is to show the details of the recipe which is selected by the user

// This will get the unique id of the recipe selected by the users which is fetched from the local storage just to avoid re-rendering
const Recipeid = localStorage.getItem("mealid")
